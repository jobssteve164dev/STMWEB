...
assert.match(runner, /stmweb\/compiler:v0\.3\.11/);
assert.match(serverEnv, /stmweb\/compiler:v0\.3\.11/);
assert.match(compose, /stmweb\/compiler:v0\.3\.11/);
assert.match(envExample, /stmweb\/compiler:v0\.3\.11/);
