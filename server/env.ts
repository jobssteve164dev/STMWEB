...
const environmentSchema = z.object({
  ...
  STMWEB_ADMIN_USERNAME: optionalString(z.string().trim().min(3).max(64)),
  STMWEB_ADMIN_PASSWORD: optionalString(z.string().min(12).max(256)),
  SZLK_PASSPORT_URL: z.string().url().default("https://passport.szlk.ai"),
  ...
  STMWEB_BUILD_IMAGE: z.string().regex(/^[a-zA-Z0-9./:_@-]+$/).default("stmweb/compiler:v0.3.11"),
