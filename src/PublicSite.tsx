...
const faqs = [
  ...
  ["现在可以无线烧录吗？", "DOT V1 已提供首次 SWD 安装和后续蓝牙升级验证通道；系统会检查芯片容量、分区、传输 CRC 和重启状态，其他设备平台将在完成各自适配后开放。", "Can I flash firmware wirelessly today?", "DOT V1 now has a validation path for first-time SWD installation and later Bluetooth updates. Chip capacity, partition, transfer CRC and restart status are checked; other device platforms will follow after their own adapters are complete."],
