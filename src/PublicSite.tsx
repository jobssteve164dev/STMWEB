...
const faqs = [
  ...
  ["现在可以无线烧录吗？", "可复现固件构建和制品管理已经可用；无线烧录仍需完成真实 Bootloader、硬件容量、传输恢复和安全条件验证后开放。", "Can I flash firmware wirelessly today?", "Reproducible builds and artefact management are available. Wireless flashing will open after real bootloader, capacity, recovery and safety conditions have been validated."],
